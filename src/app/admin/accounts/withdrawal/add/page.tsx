...
if (errorState.status) {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow mt-6">
      <h1 className="text-2xl font-bold mb-6">Add Withdrawal</h1>
...
<div>
    <label htmlFor="confirmed" className="block text-sm font-medium text-gray-700 mb-1">Confirmed</label>
    <select  id="confirmed" 
    className='w-[50%]  p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500'
    onChange={(e:React.ChangeEvent<HTMLSelectElement>)=>{
// console.log(e.target.value);
setFormData({...formData,confirmed:e.target.value as "yes" | "no" | "unknown"})
