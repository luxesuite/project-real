...
if (!result) {
   return NextResponse.json({
    success:false,
    message: `cant update investment or investment not available in the database, kindly reload the page`
    })
}

return  NextResponse.json({
        success:true,
        message: `${result.modifiedCount} investments confirmed successfully`
    })
